...
**Salvar planos em:** `.spellbook/plans/AAAA-MM-DD-<nome-da-funcionalidade>.md`
...
**Não usar para:** Ideias vagas (use `/brainstorm`), bugs simples, ou tarefas de um único arquivo.
...
- Se existir uma spec em `.spellbook/specs/`, leia-a completamente
...
- Salve no caminho: `.spellbook/plans/AAAA-MM-DD-<nome-da-funcionalidade>.md`
...
> **Para Claude:** Este plano deve ser executado usando a skill `spellbook:execute`.
