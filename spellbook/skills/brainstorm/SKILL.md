...
- Salve no caminho: `.spellbook/specs/AAAA-MM-DD-<tópico>.md`
...
**Salvar especificações em:** `.spellbook/specs/AAAA-MM-DD-<tópico>.md`
...
> **Para Claude:** Este documento deve ser usado como entrada para a skill `spellbook:plan`.
