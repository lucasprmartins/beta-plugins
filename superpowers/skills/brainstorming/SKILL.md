...
6. Consolidação da especificação: Após a validação de todas as seções, consolide a especificação em um único documento (utilize o modelo `./specification.md`) e salve no caminho `docs/.superpowers/AAAA-MM-DD-<topico>.md`.
...
- A etapa 4 diz em 3-5 abordagens, mas sinta-se livre para propor mais ou menos opções dependendo do contexto e da complexidade do problema.
...
Após a conclusão do processo, informe o caminho da especificação salva para o usuário, por exemplo: "A especificação foi salva em `docs/.superpowers/2024-06-30-nome-do-topico.md`".
